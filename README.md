...
[![VASP](https://img.shields.io/badge/VASP-5.4%2B-orange.svg)](https://www.vasp.at/)
...
- TI parameters (`TI_ATOMS`, `KPOINTS`) [web:11][web:13]

## Workflow Stages

### Stage 1: Coexistence Search
Binary search algorithm identifies solid-liquid coexistence temperature within specified tolerance [web:17].
...
- Descriptive logging with severity levels [web:17]
